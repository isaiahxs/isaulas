export const englishContent = {
    ...
    description: "Serving the community for over 12 years, Isaula's Beauty Salon offers a wide range of beauty services, including haircuts, styling, coloring, and more.",
